# n8n runbook — Supplier Document Control

## Canvas contract

- Intake: Zertifikate + Erklärungen + Kalibrierscheine.
- Context adapter: Lieferantenpflichten + Dokumentenregister (**Mocked adapter**).
- Human owner: Supplier Quality.
- Prepared target: DMS/QMS Prüfliste; external adapter remains disabled.
