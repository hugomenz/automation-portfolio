# n8n runbook — Invoice / PO Matching

## Canvas contract

- Intake: E-Rechnung / PDF + PO + Wareneingang.
- Integration status: Test-account integration.
- Human owner: Kreditorenbuchhaltung.
- Prepared target: Buchungsvorschlag; external adapter remains disabled.
...
- Mandatory human gate before the disabled Buchungsvorschlag adapter.
