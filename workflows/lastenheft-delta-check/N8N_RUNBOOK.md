# n8n runbook — Lastenheft Delta Check

## Canvas contract

- Intake: Kundenlastenheft + interner Standard.
- Context adapter: Anforderungs- und Standardmatrix (**Mocked adapter**).
- Human owner: Engineering.
- Prepared target: Review-Matrix; external adapter remains disabled.
