# n8n runbook — Customer Order Intake

## Canvas contract

- Intake: E-Mail + PDF / Excel Bestellung.
- Integration status: Test-account integration.
- Human owner: Auftragssachbearbeitung.
- Prepared target: ERP Auftrag; external adapter remains disabled.
...
- Mandatory human gate before the disabled ERP Auftrag adapter.
