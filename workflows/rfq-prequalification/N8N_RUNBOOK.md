# n8n runbook — RFQ Prequalification

## Canvas contract

- Intake: RFQ-E-Mail + technische Dokumente.
- Context adapter: CRM + freigegebene Angebotsregeln (**Mocked adapter**).
- Human owner: Technischer Vertrieb.
- Prepared target: RFQ Review Package; external adapter remains disabled.
